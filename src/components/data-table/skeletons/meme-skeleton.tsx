...
export function MemesTableSkeleton() {
  return (
    <div className="flex flex-col gap-4 animate-pulse">
      ...
      <div className="grid grid-cols-[32px_repeat(6,1fr)_32px] gap-2 mt-5">
      ...
      <div className="flex flex-col gap-2">
        {Array.from({ length: 10 }).map((_, idx) => (
          <div key={idx} className="grid grid-cols-[32px_repeat(6,1fr)_32px] gap-2">
