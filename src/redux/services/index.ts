...
import { TAG_GET_USERS, TAG_GET_TEMPLATES_ADMIN, COMMUNITY_MEMES, TAG_MEME_INTERACTION_SUMMARY } from "@/contracts/iLoveMemesApiTags";

export const iLoveMemesApi = createApi({
  reducerPath: I_LOVE_MEMES_API_REDUCER_KEY,
  tagTypes: [TAG_GET_USERS, TAG_GET_TEMPLATES_ADMIN, COMMUNITY_MEMES, TAG_MEME_INTERACTION_SUMMARY],
